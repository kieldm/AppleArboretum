class EntryImageMid {
  constructor(w_, h_){
    ...
    this.is = int(random(pgImagesMidCount));
    this.currentImage = pgImagesMid[this.is];
    ...
    if(this.imageH > pgImagesMid[this.is].height || this.imageW > pgImagesMid[this.is].width){
      this.imageW = pgImagesMid[this.is].width;
      this.imageH = pgImagesMid[this.is].height;
    }
  }
