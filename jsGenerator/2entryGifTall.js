class EntryGifTall {
  constructor(w_, h_){
    ...
    this.is = int(random(pgGifTallCount));
    this.currentImage = pgGifTall[this.is];
    ...
    if(this.imageH > pgGifTall[this.is].height || this.imageW > pgGifTall[this.is].width){
      this.imageW = pgGifTall[this.is].width;
      this.imageH = pgGifTall[this.is].height;
    }
  }
