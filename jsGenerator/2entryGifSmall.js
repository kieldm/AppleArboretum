class EntryGifSmall {
  constructor(w_, h_){
    ...
    this.is = int(random(pgGifSmallCount));
    this.currentImage = pgGifSmall[this.is];
    ...
    if(this.imageH > pgGifSmall[this.is].height || this.imageW > pgGifSmall[this.is].width){
      this.imageW = pgGifSmall[this.is].width;
      this.imageH = pgGifSmall[this.is].height;
    }
  }
